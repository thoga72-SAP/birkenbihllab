...
/** Sehr defensive JSON-Parser-Hilfe (falls wir später Prioritäten etc. aus localStorage lesen) */
...
and to learn some words and culture in the process.`
  ...
  async function handlePrepare() {
    ...
    const draft = englishLines.map((ln, lineIdx) => {
      ...
      // leichtes Entdoppeln, falls zu viele gleiche Wörter
  ...
  function pick(lineIdx, tokenIdx, choice) {
    ...
    setLines((prev) => {
      ...
      const tr = Array.isArray(line.translations)
        ? [...line.translations]
        : [];
    ...
    <div style={page}>
      <div style={wrap}>
        ...
        <p style={{ color: "#475569", marginBottom: 16 }}>
          ...
          <b>Klick</b> macht einen DeepL-Lookup nur für das Wort.
          <br />
                      ...
                      >
                        <span
                          ...
                          title={
                            isPunctTok
                              ? ""
                              : "Mouseover für Optionen / Klick = DeepL-Lookup"
                          }
                        >
                          {tok.text}
                        </span>
